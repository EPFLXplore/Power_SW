...
#define INA239_CONFIG_RST			0b1000000000000000 // 0x8000
#define INA239_CONFIG_CONVDLY		0b0011111111000000 // 0x3FC0
#define INA239_CONFIG_ADCRANGE		0b0000000000010000 // 0x0010
#define INA239_CONFIG_RST_BIT		15
#define INA239_CONFIG_CONVDLY_BIT	6
#define INA239_CONFIG_ADCRANGE_BIT	4

#define INA239_ADCCONFIG_MODE		0b1111000000000000 // 0xF000
#define INA239_ADCCONFIG_VBUSCT		0b0000111000000000 // 0x0E00
#define INA239_ADCCONFIG_VSHCT		0b0000000111000000 // 0x01C0
#define INA239_ADCCONFIG_VTCT		0b0000000000111000 // 0x0038
#define INA239_ADCCONFIG_AVG		0b0000000000000111 // 0x0007
...
public:
	...
	void initialize();
	float getPower();
	uint16_t getShuntCal() { return get(INA239_SHUNT_CAL_REG); }
	uint16_t getConfig()    { return get(INA239_CONFIG_REG); }
	//float getEnergy();
	float getVoltage();
	float getCurrent();
